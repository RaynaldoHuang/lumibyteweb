        ...
        <>       
                <div className="lg:w-11/12 lg:mx-auto lg:px-0 px-6">
                    ...
                    <div className="hidden lg:block">
                        <div className="flex bg-[#171717] py-4 mt-8 rounded-full items-center justify-between bg-[url('/element.svg')]">
                            ...
                            <div>
                                ...
                                <Link href={""} className="text-white pe-16 text-lg">About Us</Link>
                    ...
                    <div className="lg:hidden">
                        <div className="bg-[#171717] py-2 mt-8 rounded-full relative flex justify-between pe-3 ps-4 bg-[url('/element.svg')]">
                            <Image src={logo} alt="" width={100} className="ms-2" />
